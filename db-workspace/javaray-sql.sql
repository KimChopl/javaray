...
CREATE TABLE TB_FUNDING_FILE(
    REF_BNO NUMBER NOT NULL REFERENCES TB_FUNDING_BOARD(BOARD_NO),
    FILE_LEVEL NUMBER NOT NULL,
    FILE_URL VARCHAR2(400) NOT NULL,
    CONSTRAINT PK_TB_FUNDING_FILE PRIMARY KEY (REF_BNO, FILE_LEVEL) 
);
...
ALTER TABLE TB_REVIEW ADD USER_ID VARCHAR2(25) REFERENCES TB_MEMBER(USER_ID);

ALTER TABLE TB_FISHING ADD FISHING_FILE_URL VARCHAR2(1000);

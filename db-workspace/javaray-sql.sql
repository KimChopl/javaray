...
CREATE TABLE TB_FUNDING_COMPANY(
	BUSINESS_NUMBER NUMBER REFERENCES TB_BUSINESS_NUMBER_INFO PRIMARY KEY,
...
CREATE TABLE TB_FUNDING_BOARD(
	...
	CATEGORY_NO NUMBER NOT NULL REFERENCE TB_FUNDING_CATEGORY,
...
CREATE TABLE TB_PRODUCT_OPTION(
	OPTION_NO NUMBER NOT PRIMARY KEY,
	BOARD_NO NUMBER NOT NULL REFERENCE TB_FUNDING_BOARD,
...
DROP TABLE TB_FUNDING_FILES;
CREATE TABLE TB_FUNDING_FILES(
...
DROP TABLE TB_SELLER_TYPE;
CREATE TABLE TB_SELLER_TYPE(

...
CREATE TABLE TB_SHIPPING_REVIEW(
	BOOK_NO VARCHAR2(25) NOT NULL REFERENCES TB_SHIPPING_PLAY PRIMARY KEY,
...
CREATE TABLE TB_SHIPPING_PLAY(
	BOOK_NO VARCHAR2(25) NOT NULL REFERENCES TB_SHIPPING_DECIDE PRIMARY KEY,
...
CREATE TABLE TB_FUNDING_FILE(
	...
	FILE_ORIGIN_NAME VARCHAR2(200) NOT NULL,
	FILE_CHANGE_NAME VARCHAR2(200) NOT NULL,
...
ALTER TABLE TB_WEATHER_PORT ADD LAT NUMBER;
ALTER TABLE TB_WEATHER_PORT ADD LON NUMBER;

ALTER TABLE TB_FISH_CONTENT DROP COLUMN DEFAULT_SIZE;
ALTER TABLE TB_FISH_CONTENT ADD DEFAULT_SIZE VARCHAR2(240);
ALTER TABLE TB_FISH_CONTENT DROP COLUMN START_OUT_OF_SEASON;
ALTER TABLE TB_FISH_CONTENT DROP COLUMN END_OUT_OF_SEASON;
ALTER TABLE TB_FISH_CONTENT ADD START_OUT_OF_SEASON VARCHAR2(15);
ALTER TABLE TB_FISH_CONTENT ADD END_OUT_OF_SEASON VARCHAR2(15);
ALTER TABLE TB_SHIPPING ADD PRICE NUMBER;
DROP TABLE TB_SHIPPING_REVIEW;
DROP TABLE TB_SHIPPING_PLAY;
ALTER TABLE TB_SHIPPING_REVIEW ADD REVIEW_CONTENT VARCHAR2(2100) NOT NULL;
